...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const projectContent4 = `
        <h2>상세페이지 - 오월한과(가상)</h2>
        <div style="width:600px;max-width:100%;margin:1.5rem auto;text-align:center;aspect-ratio:16/9;background:#111;border-radius:16px;display:flex;align-items:center;justify-content:center;overflow:hidden;">
            <img src="img/gif01.gif" alt="오월한과 상세" style="width:100%;height:auto;max-width:600px;max-height:338px;object-fit:contain;border-radius:16px;" />
        </div>
        <div style="display:flex;justify-content:center;gap:1rem;margin-top:1.5rem;">
            <a href="https://nicky202505.github.io/project04/" target="_blank" class="btn btn-primary">상세페이지 보기</a>
            <a href="https://github.com/nicky202505/project04" target="_blank" class="btn btn-secondary">GitHub</a>
        </div>
        <div style="width:100%; padding-top:40px; margin:auto; font-size:1.1rem; line-height:2rem; color:#b8b8d1;">
            <h4>프로젝트 개요 : 가상의 오월한과 상세페이지를 이미지와 영상을 통해 
            다채롭고 동적인 이미지로 디자인하였으며, 디자인 결과물을 웹퍼블리싱으로 구현하였습니다. 
            영상 제작은 After Effect와 AI 영상제작 툴 KLING을 사용하였습니다. </h4>    
            <h4>기술 스택 : Photoshop, After Effect, HTML/CSS +  AI 영상제작 툴 KLING </h4     
            </div>  
    `;
    ...
    const projectContent6 = `
        <h2>신라호텔</h2>
        <div style="width:600px;max-width:100%;margin:1.5rem auto;text-align:center;">
            <iframe width="600" height="338" src="img/hotel.mp4" title="신라호텔 영상" frameborder="0" allowfullscreen style="display:block;margin:0 auto;border-radius:16px;"></iframe>
        </div>
        <div style="display:flex;justify-content:center;gap:1rem;margin-top:1.5rem;">
            <a href="https://nicky202505.github.io/project02/" target="_blank" class="btn btn-primary">바로 보기</a>
            <a href="https://github.com/nicky202505/project02" target="_blank" class="btn btn-secondary">GitHub</a>
        </div>
        <div style="width:100%; padding-top:40px; margin:auto; font-size:1.1rem; line-height:2rem; color:#b8b8d1;">
            <h4>프로젝트 개요: 데스크탑 전용 디자인의 신라호텔 홈페이지를 모바일까지 적용 가능한 3단계 반응형으로 리디자인하였습니다. 
            </h4>
            <h4>기술 스택 : Javascript, HTML/CSS, Responsive Design</h4>
        </div>  
    `;
    // 객체로 묶어서 기존 로직 호환
